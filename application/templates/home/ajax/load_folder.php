            ...
            foreach ($files as $file):
                ...
                <li class="sub-<?php echo md5($file['prefix']); ?>">
                    <span class="item">
                        ...
                        <span class="create-sub-folder" ><a onclick="PrettyS3FilesManager.File.fileProperties('<?php echo base64_encode($file['prefix']); ?>', '<?php echo $file['prefix']; ?>')" href="javascript:;"><i class="fa fa-eye"></i>  </a><a onclick="PrettyS3FilesManager.Bucket.deleteFolder('<?php echo base64_encode($file['prefix']); ?>', '0', '<?php echo md5($file['prefix']); ?>')" href="javascript:;"><i class="fa fa-remove"></i>  </a></span>
                    </span>
                    <span class="sub"></span>
                </li>
                <?php
